...
--algroithm Clock \ensuremath{\{
}%
\end{cpar}%
\begin{cpar}{0}{T}{F}{10.0}{0}{}%
\ensuremath{variable} \ensuremath{b \.{\in} \{0,\, 1\};
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\{ while(true) \{ if (b\.{=}0) b\.{:=}1} \ensuremath{else}
 \ensuremath{b\.{:=}0
}%
\end{cpar}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Sep} 24 14:24:26 \ensuremath{CST} 2021 by \ensuremath{wrz
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Fri} \ensuremath{Sep} 24
 14:23:12 \ensuremath{CST} 2021 by \ensuremath{wrz
}%
\end{cpar}%
\end{lcom}%
\end{document}
