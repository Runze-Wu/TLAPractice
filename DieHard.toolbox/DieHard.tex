...
\@x{\@s{35.70} \.{\land} small\@s{9.55} \.{=} 0}%
\@x{ TypeOK \.{\defeq} \.{\land} big \.{\in} 0 \.{\dotdot} 5}%
...
\@x{ FillBig \.{\defeq} \.{\land} big \.{'} \.{=} 5}%
\@x{\@s{49.69} \.{\land} small \.{'} \.{=} small}%
\@x{ FillSmall\@s{6.86} \.{\defeq} \.{\land} small \.{'} \.{=} 3}%
\@x{\@s{66.53} \.{\land} big \.{'} \.{=} big}%
\@x{ Min ( m ,\, n ) \.{\defeq} {\IF} m \.{<} n \.{\THEN} m \.{\ELSE} n}%
\@x{ BigToSmall \.{\defeq}}%
 \@x{\@s{16.4} \.{\LET} poured \.{\defeq} Min ( big \.{+} small ,\, 3 ) \.{-}
 small}%
\@x{\@s{16.4} \.{\IN} \.{\land} big \.{'} \.{=} big \.{-} poured}%
\@x{\@s{36.79} \.{\land} small \.{'} \.{=} small \.{+} poured}%
\@x{ SmallToBig \.{\defeq}}%
 \@x{\@s{16.4} \.{\LET} poured \.{\defeq} Min ( big \.{+} small ,\, 5 ) \.{-}
 big}%
\@x{\@s{16.4} \.{\IN} \.{\land} small \.{'} \.{=} small \.{-} poured}%
\@x{\@s{36.79} \.{\land} big \.{'} \.{=} big \.{+} poured}%
\@x{ Next \.{\defeq} \.{\lor} EmptyBig}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Sep} 24 15:30:41 \ensuremath{CST} 2021 by \ensuremath{wrz
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Fri} \ensuremath{Sep} 24
 15:12:54 \ensuremath{CST} 2021 by \ensuremath{wrz
}%
\end{cpar}%
\end{lcom}%
\end{document}
