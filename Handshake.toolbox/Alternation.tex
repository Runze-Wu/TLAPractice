...
\@x{ {\VARIABLES} b2 ,\, box2}%
\@pvspace{8.0pt}%
\@x{ vars2 \.{\defeq} {\langle} b2 ,\, box2 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Init2\@s{2.02} \.{\defeq} \.{\land} b2 \.{=} 0}%
\@x{\@s{32.03} \.{\land} box2 \.{=} {\langle} {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Producer2\@s{5.86} \.{\defeq} \.{\land} b2 \.{=} 0}%
\@x{\@s{58.61} \.{\land} box2 \.{'} \.{=} Put ( box2 )}%
\@x{\@s{58.61} \.{\land} b2 \.{'}\@s{7.88} \.{=} 1}%
\@x{ Consumer2 \.{\defeq} \.{\land} b2 \.{=} 1}%
\@x{\@s{58.61} \.{\land} box2 \.{'} \.{=} Get ( box2 )}%
\@x{\@s{58.61} \.{\land} b2 \.{'} \.{=} 0}%
\@pvspace{8.0pt}%
\@x{ Next2 \.{\defeq} Producer2 \.{\lor} Consumer2}%
\@pvspace{8.0pt}%
\@x{ Spec2\@s{1.46} \.{\defeq} Init2 \.{\land} {\Box} [ Next2 ]_{ vars2}}%
\@pvspace{8.0pt}%
\@x{ Invariant2 \.{\defeq} Len ( box2 ) \.{\leq} 1}%
\@pvspace{8.0pt}%
\begin{lcom}{5.0}%
...
\@x{\@s{16.4} {\p@process} {\p@lparen} Producer \.{=} 0 {\p@rparen}}%
 ...
 {\TRUE} {\p@rparen}}%
\@x{\@s{34.18} {\p@lbrace} {\p@await} b \.{=} 0 {\p@semicolon}}%
\@x{\@s{43.76} box \.{:=} Put ( box ) {\p@semicolon}}%
\@x{\@s{43.76} b \.{:=} 1 {\p@semicolon}}%
\@x{\@s{34.18} {\p@rbrace}}%
\@x{\@s{16.4} {\p@rbrace}}%
\@pvspace{8.0pt}%
 \@x{\@s{12.29} {\p@fair} {\p@process} {\p@lparen} Consumer \.{=} 1
 {\p@rparen}}%
 \@x{\@s{16.4} {\p@lbrace} c1\@s{.5}\textrm{:}\@s{3} {\p@while} {\p@lparen}
 {\TRUE} {\p@rparen}}%
\@x{\@s{34.18} {\p@lbrace} {\p@await} b \.{=} 1 {\p@semicolon}}%
\@x{\@s{43.76} box \.{:=} Get ( box ) {\p@semicolon}}%
\@x{\@s{43.76} b \.{:=} 0 {\p@semicolon}}%
\@x{\@s{34.18} {\p@rbrace}}%
\@x{\@s{16.4} {\p@rbrace}}%
\@x{ {\p@rbrace}}%
\@y{}%
...
\@x{}%
\@y{\@s{0}%
 BEGIN TRANSLATION (\ensuremath{chksum(pcal) \.{=}} ``\ensuremath{4b985bc0}''
 \ensuremath{\.{\land} chksum(tla) \.{=}} ``\ensuremath{ae3ada3a}'')
}%
\@xx{}%
\@x{ {\VARIABLES} b ,\, box}%
\@pvspace{8.0pt}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Oct} 04 11:32:02 \ensuremath{CST} 2021 by \ensuremath{wrz
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Wed} \ensuremath{Sep} 29
 10:18:30 \ensuremath{CST} 2021 by \ensuremath{wrz
}%
\end{cpar}%
\end{lcom}%
\end{document}
