...
\@x{ {\p@mmalgorithm} Handshake {\p@lbrace}}%
 \@x{\@s{16.4} {\p@variable} p \.{=} 0 ,\, c\@s{9.75} \.{=} 0 ,\, box \.{=}
 {\langle} {\rangle} {\p@semicolon}}%
\@pvspace{8.0pt}%
\@x{\@s{16.4} {\p@process} {\p@lparen} Producer \.{=} 0 {\p@rparen}}%
\@x{\@s{16.4} {\p@lbrace}}%
 \@x{\@s{32.8} c0\@s{.5}\textrm{:}\@s{3} {\p@while} {\p@lparen} {\TRUE}
 {\p@rparen}}%
\@x{\@s{49.24} {\p@lbrace}}%
\@x{\@s{65.64} {\p@await} p \.{=} c {\p@semicolon}}%
\@x{\@s{65.64} box \.{:=} Put ( box ) {\p@semicolon}}%
\@x{\@s{65.64} p \.{:=} p \.{\oplus} 1\@s{25.57} {\p@semicolon}}%
\@x{\@s{49.24} {\p@rbrace}}%
\@x{\@s{16.4} {\p@rbrace}}%
\@pvspace{8.0pt}%
\@x{\@s{16.4} {\p@process} {\p@lparen} Consumer \.{=} 1 {\p@rparen}}%
\@x{\@s{16.4} {\p@lbrace}}%
 \@x{\@s{32.8} c1\@s{.5}\textrm{:}\@s{3} {\p@while} {\p@lparen} {\TRUE}
 {\p@rparen}}%
\@x{\@s{49.24} {\p@lbrace}}%
\@x{\@s{65.64} {\p@await} p \.{\neq} c {\p@semicolon}}%
\@x{\@s{65.64} box \.{:=} Get ( box ) {\p@semicolon}}%
\@x{\@s{65.64} c \.{:=} c \.{\oplus} 1\@s{26.91} {\p@semicolon}}%
\@x{\@s{49.24} {\p@rbrace}}%
\@x{\@s{16.4} {\p@rbrace}}%
\@x{ {\p@rbrace}}%
\@y{}%
...
\@x{}%
\@y{\@s{0}%
 BEGIN TRANSLATION (\ensuremath{chksum(pcal) \.{=}} ``\ensuremath{fab02d27}''
 \ensuremath{\.{\land} chksum(tla) \.{=}} ``\ensuremath{99a6a85d}'')
}%
\@xx{}%
\@x{ {\VARIABLES} p ,\, c ,\, box}%
\@pvspace{8.0pt}%
...
\@pvspace{8.0pt}%
\@x{ Producer\@s{5.86} \.{\defeq} \.{\land} p \.{=} c}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Oct} 04 11:21:30 \ensuremath{CST} 2021 by \ensuremath{wrz
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Mon} \ensuremath{Oct} 04
 11:17:49 \ensuremath{CST} 2021 by \ensuremath{wrz
}%
\end{cpar}%
\end{lcom}%
\end{document}
