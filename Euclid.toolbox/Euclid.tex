...
\@x{}%
\@y{\@s{7.5}%
 variables \ensuremath{x \.{\in} 1\.{\dotdot}N}, \ensuremath{y \.{\in}
 1\.{\dotdot}N}, \ensuremath{x0 \.{=} x}, \ensuremath{y0 \.{=} y};
}%
\@xx{}%
\@x{\@s{16.4} {\p@variables} x \.{=} M ,\, y \.{=} N {\p@semicolon}}%
 \@x{\@s{16.4} {\p@lbrace} judge\@s{.5}\textrm{:}\@s{3} {\p@while} {\p@lparen}
 x \.{\neq} y {\p@rparen} {\p@lbrace} {\p@do} \.{:} {\p@if} {\p@lparen} x
 \.{<} y {\p@rparen} {\p@lbrace} y \.{:=} y \.{-} x {\p@rbrace}}%
\@x{\@s{100.09} {\p@else} {\p@lbrace} x \.{:=} x \.{-} y {\p@rbrace}}%
\@x{\@s{94.24} {\p@rbrace} {\p@semicolon}}%
\@x{}%
\@y{\@s{12.5}%
 print \ensuremath{{\langle}x,\, y{\rangle}};
}%
\@xx{}%
\@x{}%
\@y{\@s{12.5}%
 assert (\ensuremath{x \.{=} y}) \ensuremath{\.{\land}} (\ensuremath{x \.{=}
 GCD(x0,\, y0)});
}%
\@xx{}%
\@x{\@s{16.4} {\p@rbrace}}%
...
\@x{}%
\@y{\@s{0}%
 BEGIN TRANSLATION (\ensuremath{chksum(pcal) \.{=}} ``\ensuremath{65d8d3f8}''
 \ensuremath{\.{\land} chksum(tla) \.{=}} ``\ensuremath{9d2756b}'')
}%
\@xx{}%
\@x{ {\VARIABLES} x ,\, y ,\, pc}%
\@pvspace{8.0pt}%
...
\@x{\@s{37.72} \.{\land} pc \.{=}\@w{judge}}%
\@pvspace{8.0pt}%
\@x{ judge \.{\defeq} \.{\land} pc \.{=}\@w{judge}}%
\@x{\@s{42.38} \.{\land} {\IF} x \.{\neq} y}%
\@x{\@s{65.65} \.{\THEN} \.{\land} pc \.{'} \.{=}\@w{do}}%
\@x{\@s{65.65} \.{\ELSE} \.{\land} pc \.{'} \.{=}\@w{Done}}%
\@x{\@s{42.38} \.{\land} {\UNCHANGED} {\langle} x ,\, y {\rangle}}%
\@pvspace{8.0pt}%
\@x{ do \.{\defeq} \.{\land} pc \.{=}\@w{do}}%
\@x{\@s{29.74} \.{\land} {\IF} x \.{<} y}%
\@x{\@s{53.00} \.{\THEN} \.{\land} y \.{'}\@s{0.10} \.{=} y \.{-} x}%
\@x{\@s{84.31} \.{\land} x \.{'} \.{=} x}%
\@x{\@s{53.00} \.{\ELSE} \.{\land} x \.{'} \.{=} x \.{-} y}%
\@x{\@s{84.31} \.{\land} y \.{'}\@s{0.10} \.{=} y}%
\@x{\@s{29.74} \.{\land} pc \.{'} \.{=}\@w{judge}}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq} judge \.{\lor} do}%
\@x{\@s{52.13} \.{\lor}\@s{0.08} Terminating}%
\@pvspace{8.0pt}%
...
\@xx{}%
 \@x{ Safety \.{\defeq} ( pc \.{=}\@w{Done} ) \.{\implies} ( x \.{=} y )
 \.{\land} ( x \.{=} GCD ( M ,\, N ) )}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified Sun \ensuremath{Sep} 26
 09:36:52 \ensuremath{CST} 2021 by \ensuremath{wrz
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Fri} \ensuremath{Sep} 24
 16:52:34 \ensuremath{CST} 2021 by \ensuremath{wrz
}%
\end{cpar}%
\end{lcom}%
\end{document}
