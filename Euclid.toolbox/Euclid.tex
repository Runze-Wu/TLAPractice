...
\@x{ {\p@mmalgorithm} Euclid {\p@lbrace}}%
 \@x{\@s{16.4} {\p@variables} x \.{\in} 1 \.{\dotdot} N ,\, y\@s{13.76}
 \.{\in} 1 \.{\dotdot} N ,\, x0 \.{=} x ,\, y0 \.{=} y {\p@semicolon}}%
 \@x{\@s{16.4} {\p@lbrace} {\p@while} {\p@lparen} x \.{\neq} y {\p@rparen}
 {\p@lbrace} {\p@if} {\p@lparen} x \.{<} y {\p@rparen} {\p@lbrace} y \.{:=} y
 \.{-} x {\p@rbrace}}%
\@x{\@s{111.11} {\p@else} {\p@lbrace} x \.{:=} x \.{-} y {\p@rbrace}}%
\@x{\@s{101.53} {\p@rbrace} {\p@semicolon}}%
\@x{\@s{25.98} {\p@print} {\langle} x ,\, y {\rangle} {\p@semicolon}}%
...
\@x{}%
\@y{\@s{0}%
 BEGIN TRANSLATION (\ensuremath{chksum(pcal) \.{=}} ``\ensuremath{48d63aa1}''
 \ensuremath{\.{\land} chksum(tla) \.{=}} ``\ensuremath{2425b90e}'')
}%
\@xx{}%
...
\@x{\@s{66.11} \.{\ELSE} \.{\land} PrintT ( {\langle} x ,\, y {\rangle} )}%
 \@x{\@s{97.42} \.{\land} Assert ( ( x \.{=} y ) \.{\land} ( x \.{=} GCD ( x0
 ,\, y0 ) ) ,\,}%
\@x{\@s{141.12}\@w{Failure\ of\ assertion\ at\ line\ 11,\ column\ 7.} )}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Sep} 24 19:56:42 \ensuremath{CST} 2021 by \ensuremath{wrz
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}\.{*}} Created \ensuremath{Fri}
 \ensuremath{Sep} 24 16:52:34 \ensuremath{CST} 2021 by \ensuremath{wrz
}%
\end{cpar}%
\end{lcom}%
\end{document}
