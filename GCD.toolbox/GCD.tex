...
\@x{ {\EXTENDS} Integers}%
 ...
 q \.{*} p}%
 \@x{ DivisorsOf ( n ) \.{\defeq} \{ p \.{\in} Int\@s{14.89} \.{:} Divides ( p
 ,\, n ) \}}%
 \@x{ SetMax ( S )\@s{4.54} \.{\defeq} {\CHOOSE} i \.{\in} S \.{:} \A\, j
 \.{\in} S \.{:} i \.{\geq} j}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Sep} 24 16:22:11 \ensuremath{CST} 2021 by \ensuremath{wrz
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}\.{*}} Created \ensuremath{Fri}
 \ensuremath{Sep} 24 16:16:22 \ensuremath{CST} 2021 by \ensuremath{wrz
}%
\end{cpar}%
\end{lcom}%
\end{document}
